...
total_dias = input('Quantos dias na semana tem para estudo? ')
...
print(f'{nome} estuda {total_dias} dias na semana, estudando {total_horas} horas por dia. Total de {total_horas * total_dias} horas por semana, para chegar ao curso de {curso}')